    ...
    <div className="max-w-screen-xl mx-auto bg-gray-200">
      <main className="max-h-screen h-screen grid grid-cols-3 overflow-y-hidden">
        <aside className="grid grid-cols-1 bg-black col-span-3 sm:col-span-1 sm:row-span-2 text-white">
          ...
          <button className="bg-yellow-400 hover:bg-yellow-500 active:bg-yellow-500 mb-12 px-6 py-2 shadow-btn shadow-yellow-400/50 text-black font-semibold col-start-1 col-end-1 row-start-1 row-end-1 self-end justify-self-center active:translate-x-1 active:translate-y-1 active:shadow-none transition-all">
            {t("get_in_touch")}
          </button>
        </aside>
