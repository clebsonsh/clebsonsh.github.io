  ...
  return (
    <div className="max-w-screen-xl mx-auto bg-gray-200 scroll-smooth">
      <main className="min-h-[95vh] sm:min-h-screen grid grid-cols-3 overflow-y-hidden">
        <aside className="grid grid-cols-1 bg-neutral-700 col-span-3 sm:col-span-1 sm:row-span-2 text-white">
          ...
          <a
            href="#contact"
            className="z-10 bg-yellow-400 hover:bg-yellow-500 active:bg-yellow-500 mb-12 px-4 py-2 shadow-btn shadow-yellow-400/50 text-black font-semibold col-start-1 col-end-1 row-start-1 row-end-1 self-end justify-self-center active:translate-x-1 active:translate-y-1 active:shadow-none transition-all"
          >
            {t("get_in_touch")}
          </a>
        </aside>

        <nav className="z-10 h-16 bg-black/50 col-span-3 sm:col-span-2 col-start-1 sm:col-start-2 row-start-1 row-end-1 relative">
          <img
          ...
          <ul className="pb-1 px-8 h-full w-full text-white font-medium text-xl flex items-center justify-start gap-x-12">
            <li className="decoration-transparent hover:underline hover:underline-offset-2 hover:decoration-4 hover:decoration-yellow-400 transition-all duration-500">
        ...
        <section className="col-span-3 sm:col-span-2 col-start-1 sm:col-start-2 row-start-1 row-end-3 bg-[url('/img/profile.jpg')] bg-top bg-cover">
          <div className="z-20 pb-8 sm:-ml-48 sm:mt-24 flex flex-col sm:block items-center justify-end h-full">
            <h1 className="mb-4 font-bold text-white text-center sm:text-left text-4xl sm:text-5xl">
              CLEBSON MOURA
            </h1>
            <h2 className="sm:ml-8 py-2 px-8 bg-yellow-400 text-xl sm:text-2xl font-semibold inline-block -skew-x-[25deg]">
      ...
      <section id="works" className="bg-gray-300 py-24">
        <h2 className="text-4xl sm:text-5xl text-center font-bold underline underline-offset-1 decoration-4 decoration-yellow-400 mb-24">
          {t("awesome_projects")}
        </h2>
        <div
          id="works_list"
          className="grid grid-cols-1 md:grid-cols-3 gap-12 mx-8"
        >
          <a
      ...
      <footer
        id="contact"
        className="bg-neutral-700 py-24 text-white flex flex-col items-center justify-center gap-8"
      >
        <img
          src="/img/qr-code.png"
          alt="VCard qr code"
          className="hidden sm:block w-1/2 sm:w-64"
        />

        <a href="tel:+5511967203938" className="sm:hidden">
          +55 (11) 96720 3938
        </a>
        ...
        <div className="flex items-center gap-1 mt-2">
          ...
          >
            <svg
              className="h-5 fill-current hover:scale-150 transition-transform"
              version="1.1"
...
c5.577,5.577,11.873,8.323,17.45,2.746l1.758-1.758C48.048,40.341,48.243,39.042,47.683,37.985z"
        ...
        <p className="text-center">
          Copyright &#169; {new Date().getFullYear()} Clebson Moura
        </p>
      </footer>
    </div>
  );
